# SternerStuff\InsightlyPHP\CommentsApi
...
[**deleteEntity**](CommentsApi.md#deleteEntity) | **DELETE** /Comments/{id} | Deletes a Comment
[**getFileAttachments**](CommentsApi.md#getFileAttachments) | **GET** /Comments/{id}/FileAttachments | Gets a Comment&#39;s File Attachments
[**updateEntity**](CommentsApi.md#updateEntity) | **PUT** /Comments | Updates a Comment
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\CommentsApi(
...
try {
    ...
    echo 'Exception when calling CommentsApi->deleteEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling CommentsApi->updateEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
