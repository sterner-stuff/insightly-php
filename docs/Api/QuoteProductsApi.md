# SternerStuff\InsightlyPHP\QuoteProductsApi

All URIs are relative to *https://api.insightly.com/v3.1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**deleteImageField**](QuoteProductsApi.md#deleteImageField) | **DELETE** /QuotationLineItem/{id}/ImageField/{fieldName} | Deletes a Quote Product&#39;s Custom Image Field
[**getEntities**](QuoteProductsApi.md#getEntities) | **GET** /QuotationLineItem | Gets a list of Quote Products
[**getEntitiesBySearch**](QuoteProductsApi.md#getEntitiesBySearch) | **GET** /QuotationLineItem/Search | Gets a filtered list of Quote Products
[**getEntity**](QuoteProductsApi.md#getEntity) | **GET** /QuotationLineItem/{id} | Gets a Quote Product
[**getImageField**](QuoteProductsApi.md#getImageField) | **GET** /QuotationLineItem/{id}/ImageField/{fieldName} | Gets a Quote Product&#39;s Custom Image Field
[**updateImageField**](QuoteProductsApi.md#updateImageField) | **PUT** /QuotationLineItem/{id}/ImageField/{fieldName}/{fileName} | Updates a Quote Product&#39;s Custom Image Field
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\QuoteProductsApi(
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->deleteImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->getEntities: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->getEntitiesBySearch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->getEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->getImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling QuoteProductsApi->updateImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
