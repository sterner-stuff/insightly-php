# SternerStuff\InsightlyPHP\ProspectsApi

All URIs are relative to *https://api.insightly.com/v3.1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**addEntity**](ProspectsApi.md#addEntity) | **POST** /Prospect | Adds a Prospect
[**addFollow**](ProspectsApi.md#addFollow) | **POST** /Prospect/{id}/Follow | Start following a Prospect
[**addTag**](ProspectsApi.md#addTag) | **POST** /Prospect/{id}/Tags | Adds a Tag to a Prospect
[**deleteEntity**](ProspectsApi.md#deleteEntity) | **DELETE** /Prospect/{id} | Deletes a Prospect
[**deleteFollow**](ProspectsApi.md#deleteFollow) | **DELETE** /Prospect/{id}/Follow | Stop following a Prospect
[**deleteImageField**](ProspectsApi.md#deleteImageField) | **DELETE** /Prospect/{id}/ImageField/{fieldName} | Deletes a Prospect&#39;s Custom Image Field
[**deleteTag**](ProspectsApi.md#deleteTag) | **DELETE** /Prospect/{id}/Tags | Deletes a Tag from a Prospect
[**getEntities**](ProspectsApi.md#getEntities) | **GET** /Prospect | Gets a list of Prospects
[**getEntitiesBySearch**](ProspectsApi.md#getEntitiesBySearch) | **GET** /Prospect/Search | Gets a filtered list of Prospects
[**getEntitiesByTag**](ProspectsApi.md#getEntitiesByTag) | **GET** /Prospect/SearchByTag | Gets a list of Prospects filtered by tags
[**getEntity**](ProspectsApi.md#getEntity) | **GET** /Prospect/{id} | Gets a Prospect
[**getFollow**](ProspectsApi.md#getFollow) | **GET** /Prospect/{id}/Follow | Gets a Follow state for a Prospect
[**getImageField**](ProspectsApi.md#getImageField) | **GET** /Prospect/{id}/ImageField/{fieldName} | Gets a Prospect&#39;s Custom Image Field
[**getTags**](ProspectsApi.md#getTags) | **GET** /Prospect/{id}/Tags | Gets a Prospect&#39;s Tags
[**updateEntity**](ProspectsApi.md#updateEntity) | **PUT** /Prospect | Updates a Prospect
[**updateImageField**](ProspectsApi.md#updateImageField) | **PUT** /Prospect/{id}/ImageField/{fieldName}/{fileName} | Updates a Prospect&#39;s Custom Image Field
[**updateTags**](ProspectsApi.md#updateTags) | **PUT** /Prospect/{id}/Tags | Updates a Prospect&#39;s Tags
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\ProspectsApi(
...
try {
    ...
    echo 'Exception when calling ProspectsApi->addEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->addFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->addTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->deleteEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->deleteFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->deleteImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->deleteTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getEntities: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getEntitiesBySearch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getEntitiesByTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->getTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->updateEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->updateImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ProspectsApi->updateTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
