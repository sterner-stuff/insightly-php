# SternerStuff\InsightlyPHP\OpportunityProductsApi

All URIs are relative to *https://api.insightly.com/v3.1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**deleteImageField**](OpportunityProductsApi.md#deleteImageField) | **DELETE** /OpportunityLineItem/{id}/ImageField/{fieldName} | Deletes an Opportunity Product&#39;s Custom Image Field
[**getEntities**](OpportunityProductsApi.md#getEntities) | **GET** /OpportunityLineItem | Gets a list of Opportunity Products
[**getEntitiesBySearch**](OpportunityProductsApi.md#getEntitiesBySearch) | **GET** /OpportunityLineItem/Search | Gets a filtered list of Opportunity Products
[**getEntity**](OpportunityProductsApi.md#getEntity) | **GET** /OpportunityLineItem/{id} | Gets an Opportunity Product
[**getImageField**](OpportunityProductsApi.md#getImageField) | **GET** /OpportunityLineItem/{id}/ImageField/{fieldName} | Gets an Opportunity Product&#39;s Custom Image Field
[**updateImageField**](OpportunityProductsApi.md#updateImageField) | **PUT** /OpportunityLineItem/{id}/ImageField/{fieldName}/{fileName} | Updates an Opportunity Product&#39;s Custom Image Field
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\OpportunityProductsApi(
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->deleteImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Gets a list of Opportunity Products
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->getEntities: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Gets a filtered list of Opportunity Products
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->getEntitiesBySearch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->getEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->getImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Updates an Opportunity Product's Custom Image Field
...
try {
    ...
    echo 'Exception when calling OpportunityProductsApi->updateImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
