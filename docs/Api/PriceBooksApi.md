# SternerStuff\InsightlyPHP\PriceBooksApi

All URIs are relative to *https://api.insightly.com/v3.1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**addChildEntity**](PriceBooksApi.md#addChildEntity) | **POST** /Pricebook/{id}/PricebookEntry | Adds a Price Book Entry to a Price Book
[**addEntity**](PriceBooksApi.md#addEntity) | **POST** /Pricebook | Adds a Price Book
[**addFollow**](PriceBooksApi.md#addFollow) | **POST** /Pricebook/{id}/Follow | Start following a Price Book
[**deleteChildEntity**](PriceBooksApi.md#deleteChildEntity) | **DELETE** /Pricebook/{id}/PricebookEntry/{childEntityId} | Deletes a Price Book Entry of a Price Book
[**deleteFollow**](PriceBooksApi.md#deleteFollow) | **DELETE** /Pricebook/{id}/Follow | Stop following a Price Book
[**getChildEntities**](PriceBooksApi.md#getChildEntities) | **GET** /Pricebook/{id}/PricebookEntry | Gets a list of Price Book Entries of a Price Book
[**getEntities**](PriceBooksApi.md#getEntities) | **GET** /Pricebook | Gets a list of Price Books
[**getEntitiesBySearch**](PriceBooksApi.md#getEntitiesBySearch) | **GET** /Pricebook/Search | Gets a filtered list of Price Books
[**getEntity**](PriceBooksApi.md#getEntity) | **GET** /Pricebook/{id} | Gets a Price Book
[**getFollow**](PriceBooksApi.md#getFollow) | **GET** /Pricebook/{id}/Follow | Gets a Follow state for a Price Book
[**updateChildEntity**](PriceBooksApi.md#updateChildEntity) | **PUT** /Pricebook/{id}/PricebookEntry | Updates a Price Book Entry of a Price Book
[**updateEntity**](PriceBooksApi.md#updateEntity) | **PUT** /Pricebook | Updates a Price Book
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\PriceBooksApi(
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->addChildEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->addEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->addFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->deleteChildEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->deleteFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->getChildEntities: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->getEntities: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->getEntitiesBySearch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->getEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->getFollow: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->updateChildEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling PriceBooksApi->updateEntity: ', $e->getMessage(), PHP_EOL;
}
?>
```
