# SternerStuff\InsightlyPHP\ContactsApi
...
[**addTag**](ContactsApi.md#addTag) | **POST** /Contacts/{id}/Tags | Adds a Tag to a Contact
...
[**deleteImageField**](ContactsApi.md#deleteImageField) | **DELETE** /Contacts/{id}/ImageField/{fieldName} | Deletes a Contact&#39;s Custom Image Field
[**deleteLink**](ContactsApi.md#deleteLink) | **DELETE** /Contacts/{id}/Links/{linkId} | Deletes a Link
[**deleteTag**](ContactsApi.md#deleteTag) | **DELETE** /Contacts/{id}/Tags | Deletes a Tag from a Contact
[**getDates**](ContactsApi.md#getDates) | **GET** /Contacts/{id}/Dates | Gets a Contact&#39;s Dates
...
[**getImageField**](ContactsApi.md#getImageField) | **GET** /Contacts/{id}/ImageField/{fieldName} | Gets a Contact&#39;s Custom Image Field
[**getLinks**](ContactsApi.md#getLinks) | **GET** /Contacts/{id}/Links | Gets a Contact&#39;s Links
[**getNotes**](ContactsApi.md#getNotes) | **GET** /Contacts/{id}/Notes | Gets a Contact&#39;s Notes
[**getTags**](ContactsApi.md#getTags) | **GET** /Contacts/{id}/Tags | Gets a Contact&#39;s Tags
[**getTasks**](ContactsApi.md#getTasks) | **GET** /Contacts/{id}/Tasks | Gets a list of a Contact&#39;s Tasks
[**updateDates**](ContactsApi.md#updateDates) | **PUT** /Contacts/{id}/Dates | Updates a Contact&#39;s Dates
...
[**updateImageField**](ContactsApi.md#updateImageField) | **PUT** /Contacts/{id}/ImageField/{fieldName}/{fileName} | Updates a Contact&#39;s Custom Image Field
...
[**updateTags**](ContactsApi.md#updateTags) | **PUT** /Contacts/{id}/Tags | Updates a Contact&#39;s Tags
...
$apiInstance = new SternerStuff\InsightlyPHP\Api\ContactsApi(
...
try {
    ...
    echo 'Exception when calling ContactsApi->deleteImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ContactsApi->getDates: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\SternerStuff\InsightlyPHP\Model\APIDate[]**](../Model/APIDate.md)
...
try {
    ...
    echo 'Exception when calling ContactsApi->getImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ContactsApi->getTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ContactsApi->updateDates: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **id** | **int**| A Record&#39;s ID |
 **authorization** | **string**| Authorization | [default to {{Authorization}}]
 **api_dates** | [**\SternerStuff\InsightlyPHP\Model\APIDate**](../Model/APIDate.md)| The Date collection to update |
...
Updates a Contact's Custom Image Field
...
try {
    ...
    echo 'Exception when calling ContactsApi->updateImageField: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ContactsApi->updateTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
