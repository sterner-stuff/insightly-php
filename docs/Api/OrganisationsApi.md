# SternerStuff\InsightlyPHP\OrganisationsApi
...
[**addEntity**](OrganisationsApi.md#addEntity) | **POST** /Organisations | Adds an Organisation
...
[**addNotes**](OrganisationsApi.md#addNotes) | **POST** /Organisations/{id}/Notes | Adds a Note to an Organisation
[**addTag**](OrganisationsApi.md#addTag) | **POST** /Organisations/{id}/Tags | Adds a Tag to an Organisation
[**deleteEntity**](OrganisationsApi.md#deleteEntity) | **DELETE** /Organisations/{id} | Deletes an Organisation
...
[**deleteImageField**](OrganisationsApi.md#deleteImageField) | **DELETE** /Organisations/{id}/ImageField/{fieldName} | Deletes an Organisation&#39;s Custom Image Field
[**deleteLink**](OrganisationsApi.md#deleteLink) | **DELETE** /Organisations/{id}/Links/{linkId} | Deletes a Link
[**deleteTag**](OrganisationsApi.md#deleteTag) | **DELETE** /Organisations/{id}/Tags | Deletes a Tag from an Organisation
[**getDates**](OrganisationsApi.md#getDates) | **GET** /Organisations/{id}/Dates | Gets an Organisation&#39;s Dates
[**getEmailDomains**](OrganisationsApi.md#getEmailDomains) | **GET** /Organisations/{id}/EmailDomains | Gets an Organisation&#39;s Email Domains
[**getEmails**](OrganisationsApi.md#getEmails) | **GET** /Organisations/{id}/Emails | Gets a list of an Organisation&#39;s Emails
[**getEntities**](OrganisationsApi.md#getEntities) | **GET** /Organisations | Gets a list of Organisations
[**getEntitiesBySearch**](OrganisationsApi.md#getEntitiesBySearch) | **GET** /Organisations/Search | Gets a filtered list of Organisations
[**getEntitiesByTag**](OrganisationsApi.md#getEntitiesByTag) | **GET** /Organisations/SearchByTag | Gets a list of Organisations filtered by tags
[**getEntity**](OrganisationsApi.md#getEntity) | **GET** /Organisations/{id} | Gets an Organisation
...
[**getFollow**](OrganisationsApi.md#getFollow) | **GET** /Organisations/{id}/Follow | Gets a Follow state for an Organisation
[**getImage**](OrganisationsApi.md#getImage) | **GET** /Organisations/{id}/Image | Gets an Organisation&#39;s Image
[**getImageField**](OrganisationsApi.md#getImageField) | **GET** /Organisations/{id}/ImageField/{fieldName} | Gets an Organisation&#39;s Custom Image Field
[**getLinks**](OrganisationsApi.md#getLinks) | **GET** /Organisations/{id}/Links | Gets an Organisation&#39;s Links
[**getNotes**](OrganisationsApi.md#getNotes) | **GET** /Organisations/{id}/Notes | Gets an Organisation&#39;s Notes
[**getTags**](OrganisationsApi.md#getTags) | **GET** /Organisations/{id}/Tags | Gets an Organisation&#39;s Tags
[**getTasks**](OrganisationsApi.md#getTasks) | **GET** /Organisations/{id}/Tasks | Gets a list of an Organisation&#39;s Tasks
[**updateDates**](OrganisationsApi.md#updateDates) | **PUT** /Organisations/{id}/Dates | Updates an Organisation&#39;s Dates
[**updateEmailDomains**](OrganisationsApi.md#updateEmailDomains) | **PUT** /Organisations/{id}/EmailDomains | Updates an Organisation&#39;s Email Domains
[**updateEntity**](OrganisationsApi.md#updateEntity) | **PUT** /Organisations | Updates an Organisation
[**updateImage**](OrganisationsApi.md#updateImage) | **PUT** /Organisations/{id}/Image/{filename} | Updates an Organisation&#39;s Image
[**updateImageField**](OrganisationsApi.md#updateImageField) | **PUT** /Organisations/{id}/ImageField/{fieldName}/{fileName} | Updates an Organisation&#39;s Custom Image Field
[**updateLink**](OrganisationsApi.md#updateLink) | **PUT** /Organisations/{id}/Links | Updates a Link
[**updateNotes**](OrganisationsApi.md#updateNotes) | **PUT** /Organisations/{id}/Notes | Updates a note of an Organisation
[**updateTags**](OrganisationsApi.md#updateTags) | **PUT** /Organisations/{id}/Tags | Updates an Organisation&#39;s Tags
...
[**\SternerStuff\InsightlyPHP\Model\APIEmailDomain[]**](../Model/APIEmailDomain.md)
 ...
 **id** | **int**| A Record&#39;s ID |
 **authorization** | **string**| Authorization | [default to {{Authorization}}]
 **api_email_domains** | [**\SternerStuff\InsightlyPHP\Model\APIEmailDomain**](../Model/APIEmailDomain.md)| The Record&#39;s Email Domains |
