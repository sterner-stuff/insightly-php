...
------------- | ------------- | -------------
[**addEntity**](KnowledgeArticlesApi.md#addEntity) | **POST** /KnowledgeArticle | Adds a Knowledge Article
[**addFollow**](KnowledgeArticlesApi.md#addFollow) | **POST** /KnowledgeArticle/{id}/Follow | Start following a Knowledge Article
[**addTag**](KnowledgeArticlesApi.md#addTag) | **POST** /KnowledgeArticle/{id}/Tags | Adds a Tag to a Knowledge Article
[**addTranslation**](KnowledgeArticlesApi.md#addTranslation) | **POST** /KnowledgeArticle/{id}/Translations/{language} | Adds a Translation for a Knowledge Article in a specific language
[**deleteEntity**](KnowledgeArticlesApi.md#deleteEntity) | **DELETE** /KnowledgeArticle/{id} | Deletes a Knowledge Article
[**deleteFollow**](KnowledgeArticlesApi.md#deleteFollow) | **DELETE** /KnowledgeArticle/{id}/Follow | Stop following a Knowledge Article
[**deleteImageField**](KnowledgeArticlesApi.md#deleteImageField) | **DELETE** /KnowledgeArticle/{id}/ImageField/{fieldName} | Deletes a Knowledge Article&#39;s Custom Image Field
[**deleteTag**](KnowledgeArticlesApi.md#deleteTag) | **DELETE** /KnowledgeArticle/{id}/Tags | Deletes a Tag from a Knowledge Article
[**getEntities**](KnowledgeArticlesApi.md#getEntities) | **GET** /KnowledgeArticle | Gets a list of Knowledge Articles
[**getEntitiesBySearch**](KnowledgeArticlesApi.md#getEntitiesBySearch) | **GET** /KnowledgeArticle/Search | Gets a filtered list of Knowledge Articles
[**getEntitiesByTag**](KnowledgeArticlesApi.md#getEntitiesByTag) | **GET** /KnowledgeArticle/SearchByTag | Gets a list of Knowledge Articles filtered by tags
[**getEntity**](KnowledgeArticlesApi.md#getEntity) | **GET** /KnowledgeArticle/{id} | Gets a Knowledge Article
[**getFollow**](KnowledgeArticlesApi.md#getFollow) | **GET** /KnowledgeArticle/{id}/Follow | Gets a Follow state for a Knowledge Article
[**getImageField**](KnowledgeArticlesApi.md#getImageField) | **GET** /KnowledgeArticle/{id}/ImageField/{fieldName} | Gets a Knowledge Article&#39;s Custom Image Field
[**getTags**](KnowledgeArticlesApi.md#getTags) | **GET** /KnowledgeArticle/{id}/Tags | Gets a Knowledge Article&#39;s Tags
[**getTranslation**](KnowledgeArticlesApi.md#getTranslation) | **GET** /KnowledgeArticle/{id}/Translations/{language} | Gets a Knowledge Article&#39;s translation in a specific language
[**updateEntity**](KnowledgeArticlesApi.md#updateEntity) | **PUT** /KnowledgeArticle | Updates a Knowledge Article
[**updateImageField**](KnowledgeArticlesApi.md#updateImageField) | **PUT** /KnowledgeArticle/{id}/ImageField/{fieldName}/{fileName} | Updates a Knowledge Article&#39;s Custom Image Field
[**updateTags**](KnowledgeArticlesApi.md#updateTags) | **PUT** /KnowledgeArticle/{id}/Tags | Updates a Knowledge Article&#39;s Tags
[**updateTranslation**](KnowledgeArticlesApi.md#updateTranslation) | **PUT** /KnowledgeArticle/{id}/Translations/{language} | Updates a Knowledge Article&#39;s translation in a specific language
