...
class APIEvent implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling APIEvent., must be smaller than or equal to 255.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (mb_strlen($location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $location when calling APIEvent., must be smaller than or equal to 255.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (mb_strlen($details) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $details when calling APIEvent., must be smaller than or equal to 4000.');
        }
