...
class APIMilestone implements ModelInterface, ArrayAccess
{
    ...
    {
        if (!is_null($title) && (mb_strlen($title) > 500)) {
            throw new \InvalidArgumentException('invalid length for $title when calling APIMilestone., must be smaller than or equal to 500.');
        }
