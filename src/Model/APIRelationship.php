...
class APIRelationship implements ModelInterface, ArrayAccess
{
    ...
    {
        if (!is_null($forward_title) && (mb_strlen($forward_title) > 255)) {
        ...
        if (!is_null($forward_title) && (mb_strlen($forward_title) < 0)) {
    ...
    {
        if (!is_null($forward) && (mb_strlen($forward) > 255)) {
        ...
        if (!is_null($forward) && (mb_strlen($forward) < 0)) {
    ...
    {
        if (!is_null($reverse_title) && (mb_strlen($reverse_title) > 255)) {
        ...
        if (!is_null($reverse_title) && (mb_strlen($reverse_title) < 0)) {
    ...
    {
        if (!is_null($reverse) && (mb_strlen($reverse) > 255)) {
        ...
        if (!is_null($reverse) && (mb_strlen($reverse) < 0)) {
