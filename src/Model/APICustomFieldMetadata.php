...
class APICustomFieldMetadata implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'editable' => 'bool',
        'visible' => 'bool',
        'custom_field_options' => '\SternerStuff\InsightlyPHP\Model\APICustomFieldOption[]',
        'dependency' => '\SternerStuff\InsightlyPHP\Model\APICustomFieldDependency',
        'join_object' => 'string'
    ];
    ...
    {
        if (!is_null($field_help_text) && (mb_strlen($field_help_text) > 1000)) {
        ...
        if (!is_null($field_help_text) && (mb_strlen($field_help_text) < 0)) {
     ...
     *
     * @return \SternerStuff\InsightlyPHP\Model\APICustomFieldOption[]
     */
     ...
     *
     * @param \SternerStuff\InsightlyPHP\Model\APICustomFieldOption[] $custom_field_options custom_field_options
     *
     * @return $this
     */
     ...
     * Gets dependency
     *
     * @return \SternerStuff\InsightlyPHP\Model\APICustomFieldDependency
     */
     ...
     * Sets dependency
     *
     * @param \SternerStuff\InsightlyPHP\Model\APICustomFieldDependency $dependency dependency
     *
     * @return $this
     */
