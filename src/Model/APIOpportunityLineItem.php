...
/**
 * APIOpportunityLineItem Class Doc Comment
 *
 * @category Class
 * @package  SternerStuff\InsightlyPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class APIOpportunityLineItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'APIOpportunityLineItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['opportunity_id'] === null) {
            $invalidProperties[] = "'opportunity_id' can't be null";
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling APIOpportunityLineItem., must be smaller than or equal to 3.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling APIOpportunityLineItem., must be smaller than or equal to 255.');
        }
     ...
     * Sets service_date
     *
     * @param \DateTime $service_date service_date
     *
     * @return $this
     */
