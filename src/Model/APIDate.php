...
class APIDate implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['occasion_name']) && (mb_strlen($this->container['occasion_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'occasion_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['occasion_name']) && (mb_strlen($this->container['occasion_name']) < 0)) {
    ...
    {
        if (!is_null($occasion_name) && (mb_strlen($occasion_name) > 255)) {
        ...
        if (!is_null($occasion_name) && (mb_strlen($occasion_name) < 0)) {
