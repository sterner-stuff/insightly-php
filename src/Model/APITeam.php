...
class APITeam implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'teammembers' => '\SternerStuff\InsightlyPHP\Model\APITeamMember[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['team_name']) && (mb_strlen($this->container['team_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'team_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['team_name']) && (mb_strlen($this->container['team_name']) < 0)) {
    ...
    {
        if (!is_null($team_name) && (mb_strlen($team_name) > 255)) {
        ...
        if (!is_null($team_name) && (mb_strlen($team_name) < 0)) {
     ...
     * Gets teammembers
     *
     * @return \SternerStuff\InsightlyPHP\Model\APITeamMember[]
     */
     ...
     * Sets teammembers
     *
     * @param \SternerStuff\InsightlyPHP\Model\APITeamMember[] $teammembers teammembers
     *
     * @return $this
     */
