...
class APICategory implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((mb_strlen($background_color) > 6)) {
        ...
        if ((mb_strlen($background_color) < 0)) {
