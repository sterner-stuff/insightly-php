...
class PermissionsApi
{
     ...
     * @return \SternerStuff\InsightlyPHP\Model\APIPermissions
     */
     ...
     * @throws \SternerStuff\InsightlyPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SternerStuff\InsightlyPHP\Model\APIPermissions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPermissionsWithHttpInfo()
    {
        $returnType = '\SternerStuff\InsightlyPHP\Model\APIPermissions';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SternerStuff\InsightlyPHP\Model\APIPermissions',
