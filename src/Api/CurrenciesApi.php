...
class CurrenciesApi
{
     ...
     * @return \SternerStuff\InsightlyPHP\Model\APICurrency[]
     */
     ...
     * @throws \SternerStuff\InsightlyPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SternerStuff\InsightlyPHP\Model\APICurrency[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrenciesWithHttpInfo()
    {
        $returnType = '\SternerStuff\InsightlyPHP\Model\APICurrency[]';
