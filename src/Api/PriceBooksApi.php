...
/**
 * PriceBooksApi Class Doc Comment
 *
 * @category Class
 * @package  SternerStuff\InsightlyPHP
 * @author   Swagger Codegen team
...
class PriceBooksApi
{
    ...
    protected function addChildEntityRequest($id, $authorization, $api_child_entity)
    {
        ...
        $resourcePath = '/Pricebook/{id}/PricebookEntry';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFollowRequest($id, $authorization)
    {
        ...
        $resourcePath = '/Pricebook/{id}/Follow';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteChildEntityRequest($id, $child_entity_id, $authorization)
    {
        ...
        $resourcePath = '/Pricebook/{id}/PricebookEntry/{childEntityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
