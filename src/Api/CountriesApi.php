...
class CountriesApi
{
     ...
     * @return \SternerStuff\InsightlyPHP\Model\APICountry[]
     */
     ...
     * @throws \SternerStuff\InsightlyPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SternerStuff\InsightlyPHP\Model\APICountry[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCountriesWithHttpInfo()
    {
        $returnType = '\SternerStuff\InsightlyPHP\Model\APICountry[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SternerStuff\InsightlyPHP\Model\APICountry[]',
