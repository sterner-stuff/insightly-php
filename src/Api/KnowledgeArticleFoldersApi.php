...
/**
 * KnowledgeArticleFoldersApi Class Doc Comment
 *
 * @category Class
 * @package  SternerStuff\InsightlyPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KnowledgeArticleFoldersApi
{
    /**
     * @var ClientInterface
     */
    ...
    protected function addEntityRequest($authorization, $field_values)
    {
        ...
        $resourcePath = '/KnowledgeArticleFolder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEntitiesBySearchRequest($authorization, $field_name = null, $field_value = null, $updated_after_utc = null, $brief = 'false', $skip = null, $top = null, $count_total = 'false')
    {
        ...
        $resourcePath = '/KnowledgeArticleFolder/Search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEntityRequest($id, $authorization)
    {
        ...
        $resourcePath = '/KnowledgeArticleFolder/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
