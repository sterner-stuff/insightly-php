...
class InstanceApi
{
     ...
     * @return \SternerStuff\InsightlyPHP\Model\APIInstance
     */
     ...
     * @throws \SternerStuff\InsightlyPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SternerStuff\InsightlyPHP\Model\APIInstance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInstanceWithHttpInfo()
    {
        $returnType = '\SternerStuff\InsightlyPHP\Model\APIInstance';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SternerStuff\InsightlyPHP\Model\APIInstance',
